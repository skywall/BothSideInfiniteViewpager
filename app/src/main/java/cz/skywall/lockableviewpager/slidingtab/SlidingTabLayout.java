package cz.skywall.lockableviewpager.slidingtab;/*
 ...
 * via {setSelectedIndicatorColors(int...)} and {setDividerColors(int...)}. The
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void notifyDataSetChanged() {
        ...
        } else if(childViewsCount > adapterChildCount) { // need to delee some views
    ...
    private void smoothScrollToTab(int tabIndex, int positionOffset) {
        final int tabStripChildCount = mTabStrip.getChildCount();
        if (tabStripChildCount == 0 || tabIndex < 0 || tabIndex >= tabStripChildCount) {
            return;
        }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            int extraOffset = (selectedTitle != null)
                    ...
                    : 0;
            smoothScrollToTab(position, extraOffset);

            //smoothScrollToTab(position, (int) (positionOffset * mTabStrip.getChildAt(position).getWidth()));
